	...
	public class analizadorSintactico {
		...
		public bool analizar() {
			...
			do {
				...
				String s = "";
				/*
				foreach(var v in arbol) {
					if(v.ToString() == "Analizador_lexico.NoTerminal") {
						
						while(((NoTerminal)v).nodo != null) {
							s += ((NoTerminal)v).nodo.simbolo + " ";
							((NoTerminal)v).nodo = ((NoTerminal)v).siguiente;
						}
						s +=  "\n ";
					}
				}
