...
namespace Analizador_lexico
{
	partial class MainForm
	{
		...
		private void InitializeComponent() {
			...
			// dataTableError
			// 
			this.dataTableError.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dataTableError.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
									this.lexemaError,
									this.filaError,
									this.columnaError});
			this.dataTableError.Location = new System.Drawing.Point(4, 612);
			this.dataTableError.Name = "dataTableError";
			this.dataTableError.RowTemplate.Height = 24;
			this.dataTableError.Size = new System.Drawing.Size(608, 120);
			this.dataTableError.TabIndex = 1;
			// 
			// dataTable
			// 
