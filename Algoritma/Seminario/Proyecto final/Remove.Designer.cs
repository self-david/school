...
namespace ProyectPreyPredator {
	partial class Remove {
		...
		private void InitializeComponent() {
			...
			this.lblClosed.Location = new System.Drawing.Point(482, -5);
			...
			this.lblOk.Location = new System.Drawing.Point(11, 333);
			this.lblOk.Name = "lblOk";
			this.lblOk.Size = new System.Drawing.Size(238, 35);
			this.lblOk.TabIndex = 7;
			this.lblOk.Text = "Eliminar";
			this.lblOk.TextAlign = System.Drawing.ContentAlignment.TopCenter;
			this.lblOk.Click += new System.EventHandler(this.ClickRemovePrey);
			// 
			// label1
			// 
			...
			this.label1.Location = new System.Drawing.Point(263, 333);
			this.label1.Name = "label1";
			this.label1.Size = new System.Drawing.Size(237, 35);
			this.label1.TabIndex = 9;
			this.label1.Text = "Eliminar";
			this.label1.TextAlign = System.Drawing.ContentAlignment.TopCenter;
			this.label1.Click += new System.EventHandler(this.ClickRemovePredator);
			// 
			// label2
			// 
			...
			// treeViewPredators
			// 
			this.treeViewPredators.Location = new System.Drawing.Point(263, 68);
			this.treeViewPredators.Name = "treeViewPredators";
			this.treeViewPredators.Size = new System.Drawing.Size(238, 247);
			this.treeViewPredators.TabIndex = 14;
			// 
			// label3
			// 
			...
			this.label3.Text = "PRESAS";
			this.label3.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// treeViewPreys
			// 
			this.treeViewPreys.Location = new System.Drawing.Point(11, 68);
			this.treeViewPreys.Name = "treeViewPreys";
			this.treeViewPreys.Size = new System.Drawing.Size(238, 247);
			this.treeViewPreys.TabIndex = 12;
			// 
			// Remove
			// 
